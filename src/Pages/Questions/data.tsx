...
export const quizQuestion = [
  {
    ...
    questions: [
      {
        question: ' What is the length of a professional cricket pitch?',
        points: 10,
        options: [
          {
            value: '29 Yards',
      ...
      {
        question: ' What is the length of a professional cricket stump?',
        points: 10,
      ...
      {
        question: ' How much does a new cricket ball weigh?.',
        points: 10,
        options: [
          {
            value: ' 5.5 ounces',
      ...
      {
        question: ' Which West Indian fast bowler was known as “Hit Man”?',
        points: 10,
        options: [
          {
            value: ' Andy Roberts',
  ...
  },
  {
    ...
    questions: [
      {
        question: 'Which nation won the 1986 World Cup?',
        points: 10,
        options: [
          {
            value: 'West Germany',
      ...
      {
        question: 'What is the maximum allowable weight for a football? ',
        points: 10,
        options: [
          {
            value: '450 grams',
